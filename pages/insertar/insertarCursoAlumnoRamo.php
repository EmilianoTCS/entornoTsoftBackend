...
if (isset($_GET['insertarCursoAlumnoRamo'])) {
    ...
    $data->estadoRamo = "" || $data->estadoRamo = null || $data->estadoRamo = 0 ? $estadoRamo = '1' : $estadoRamo = $data->estadoRamo;
    ...
    $query = "CALL SP_insertarCursoAlumnoRamo('$fechaIni','$fechaFin','$horaIni','$horaFin', $porcAsistencia, $porcParticipacion, '$ramoAprobado', $porcAprobacion,'$estadoRamo',$idCursoAlumno,$idRamo,'$isActive','$usuarioCreacion', @p0, @p1)";

...
if (isset($_GET['editarEddEvalProyEmp'])) {
    ...
    $query = "CALL SP_editarEddEvalProyEmp($idEDDEvalProyEmp, $idEDDEvaluacion, $idEDDProyEmpEvaluador, $idEDDProyEmpEvaluado, '$evalRespondida', '$isActive', '$usuarioModificacion', @p0, @p1)";

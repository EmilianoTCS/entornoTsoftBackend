...
if (isset($_GET['editarCursoAlumnoSesion'])) {
    ...
    $query = "CALL SP_editarCursoAlumnoSesion($idCursoAlumnoSesion, '$fechaIni','$fechaFin', $asistencia, $participacion, $isActive, $idSesion, $idCursoAlumno, '$usuarioModificacion', @p0, @p1)";

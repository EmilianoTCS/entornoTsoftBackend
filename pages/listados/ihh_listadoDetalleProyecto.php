    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            $json[] = array(
                ...
                'presupuestoAcumuladoUSD' => $row['presupuestoAcumuladoUSD'],
                'presupuestoAcumuladoPesos' => $row['presupuestoAcumuladoPesos'],
                'costoMensualUSD' => $row['costoMensualUSD'],
                'costoMensualPesos' => $row['costoMensualPesos'],
                'saldoMensualUSD' => $row['saldoMensualUSD'],
                'saldoMensualPesos' => $row['saldoMensualPesos'],
                'saldoPresupuestoUSD' => $row['saldoPresupuestoUSD'],
                'saldoPresupuestoPesos' => $row['saldoPresupuestoPesos'],
